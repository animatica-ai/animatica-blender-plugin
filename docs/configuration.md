...
This is the default. Generation runs on Animatica's servers — you don't need a
powerful GPU in Blender or any extra downloads.
...
Only if you already run motion generation on your computer or local network:
